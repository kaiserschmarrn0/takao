...
STATIC UNICODE_TO_CHAR UnicodeToPcAnsiOrAscii[] = {
	...
	// BUG: Left Arrow is an ESC. We can not make it print
	...
	// BUG: Took out left arrow so right has to go too.
	// { ARROW_RIGHT,                        0x1a, L'>'},
...
BOOLEAN LibIsValidTextGraphics(IN  CHAR16  Graphic,
...
BOOLEAN IsValidAscii(IN  CHAR16  Ascii)
{
...
BOOLEAN IsValidEfiCntlChar(IN  CHAR16  c)
{
