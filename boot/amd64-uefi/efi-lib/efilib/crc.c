...
--*/
VOID SetCrc (IN OUT EFI_TABLE_HEADER *Hdr)
{
...
--*/
VOID
SetCrcAltSize (IN UINTN Size, IN OUT EFI_TABLE_HEADER *Hdr)
{
	Hdr->CRC32 = 0;
...
--*/
BOOLEAN CheckCrc (IN UINTN MaxSize, IN OUT EFI_TABLE_HEADER *Hdr)
{
...
--*/
BOOLEAN
CheckCrcAltSize (IN UINTN MaxSize, IN UINTN Size, 
...
UINT32 CalculateCrc (UINT8 *pt, UINTN Size)
{
	UINTN Crc;
