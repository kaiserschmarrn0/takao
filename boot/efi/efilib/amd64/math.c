...
// LShiftU64 : Left shift 64 bit by 32 bit and ger a 64 bit result
...
// MultU64x32 : Multiple 64bit by 32bit and get a 64bit result
...
// DivU64x32 : divide 64bit by 32bit and get a 64bit result, only works for 31bit divisors!!
UINT64 DivU64x32(IN UINT64 Dividend, IN UINTN Divisor, OUT UINTN *Remainder OPTIONAL)
{
#if defined(__GNUC__) || defined(_MSC_EXTENSIONS)
	if (Remainder)
